...
def generate_launch_description():
    ...
    def select_hand_side(context):
        ...
        hand_side = hand_side_override or ('right' if model_name == 'XDG5FR' else 'left')
        return [
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='WebSocket client host (xela_server2_dg5f_node).',
        ),
        DeclareLaunchArgument(
            'ws_port',
            default_value='5000',
            description='WebSocket client port (xela_server2_dg5f_node).',
        ),
        DeclareLaunchArgument(
            'warmup_sec',
            default_value='5.0',
