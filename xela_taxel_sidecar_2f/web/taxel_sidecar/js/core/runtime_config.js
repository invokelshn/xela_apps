export function buildRuntimeConfig(windowRef) {
  ...
  const followCamForwardDistance = parseNum(params.get("follow_cam_forward_distance"), -0.2);
  const followCamHeightOffset = parseNum(params.get("follow_cam_height_offset"), 0.1);
