h1. Functional Specification Document (FSD) - xela_server2_ah
...
h3. 2.2 JSON Schema (based on XR23AHLCPP_left.json)
...
h3. 4.1 Joint Name Parsing Rules
...
h3. 4.10 Hand Side Prefix Mapping
...
h3. 4.9 Example Mapping (Excerpt)
...
h2. 6. Processing Flow

# Connect to WebSocket and subscribe to text messages.
# Parse incoming JSON message.
# Validate required fields and array lengths.
# Load @taxel_joint_map@ once and cache frame list.
# Build @XTaxelSensorArray@ and publish to @/x_taxel_ah@.

h2. 7. Validation and Error Handling
