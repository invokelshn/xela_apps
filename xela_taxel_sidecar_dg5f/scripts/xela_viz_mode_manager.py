...
class XelaVizModeManager(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("model_name", "XDG5FR")
        ...
        self.declare_parameter("legacy_out_topic", "/x_taxel_dg5f/markers")
    ...
    def _stop_current_viz(self) -> None:
        subprocess.run(["pkill", "-f", "std_xela_taxel_viz_dg5f_node"], check=False)
